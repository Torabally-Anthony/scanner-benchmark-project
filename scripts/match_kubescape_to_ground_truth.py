...
NORMALISED_FILE = Path("results/normalised/kubescape/case-001-privileged-container.normalised.json")
GROUND_TRUTH_FILE = Path("corpus/kubernetes/case-001-privileged-container/ground_truth.yaml")
OUTPUT_FILE = Path("results/matched/kubescape/case-001-privileged-container.matched.json")
...
def finding_matches_ground_truth(finding: dict, ground_truth: dict) -> bool:
    ...
    same_field_path = finding.get("expected_field_path") == ground_truth.get("field_path")
...
def main() -> None:
    ...
    for ground_truth in ground_truth_items:
        ...
        if matched_finding:
            ...
            false_negatives.append({
                ...
                "missed_reason": "No mapped Kubescape finding matched this ground truth item.",
            })
    ...
    print("Kubescape matching completed.")
